                  ...
                  <div className="space-y-2">
                    <div
                      className={`flex cursor-pointer items-center justify-between rounded px-3 py-2 transition-colors ${
                        hoveredSection === getSectionId(color.name, 'OKLCH')
                    ...
                    <div
                      className={`flex cursor-pointer items-center justify-between rounded px-3 py-2 transition-colors ${
                        hoveredSection === getSectionId(color.name, 'CSS')
                          ? 'bg-euri-steel-gray-200 dark:bg-euri-charcoal-700'
                          : 'bg-euri-steel-gray-100 dark:bg-euri-charcoal-800 hover:bg-euri-steel-gray-200 dark:hover:bg-euri-charcoal-700'
                      }`}
                    ...
                    <div
                      className={`flex cursor-pointer items-center justify-between rounded px-3 py-2 transition-colors ${
                        hoveredSection === getSectionId(color.name, 'HEX')
                          ? 'bg-euri-steel-gray-200 dark:bg-euri-charcoal-700'
                          : 'bg-euri-steel-gray-100 dark:bg-euri-charcoal-800 hover:bg-euri-steel-gray-200 dark:hover:bg-euri-charcoal-700'
                      }`}
                    ...
                    <div
                      className={`flex cursor-pointer items-center justify-between rounded px-3 py-2 transition-colors ${
                        hoveredSection === getSectionId(color.name, 'Tailwind')
                          ? 'bg-euri-steel-gray-200 dark:bg-euri-charcoal-700'
                          : 'bg-euri-steel-gray-100 dark:bg-euri-charcoal-800 hover:bg-euri-steel-gray-200 dark:hover:bg-euri-charcoal-700'
                      }`}
